...
import { registerBrand } from "../../store/actions/brandActions";
...
interface brandProps extends RouteComponentProps {
  registerBrand: (brand: Category) => void;
  location: any;
  role: any;
  auth: any;
  authError?: any;
...
const BrandForm: React.FC<brandProps> = ({ registerBrand }) => {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    var res = await registerBrand(brand);
...
export default connect(mapStateToProps, { registerBrand })(BrandForm);
